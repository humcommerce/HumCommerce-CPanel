...
<div class="callout callout-warning" aria-label="warning">
	...
	<div>
		...
		<button class="btn btn-primary ng-scope" onclick='window.open("https://www.humcommerce.com/life-time-deal/ref/<?php echo $AffilateID?>")'>SignUp to HumCommerce for free</button>
    	</div>
</div>
